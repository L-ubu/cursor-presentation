...
<div class="divider-slide" bind:this={slideEl}>
	<p style="font-size: 0.85rem; color: #eab308; letter-spacing: 0.2em; text-transform: uppercase; font-weight: 700; opacity: {stepOpacity.current};">
		Step 3 of 3
	</p>
	...
	<p style="font-size: 1.2rem; color: var(--text-muted); margin-top: 0.5rem; opacity: {stepOpacity.current};">
		JWT contains full plaintext API key
	</p>
</div>
